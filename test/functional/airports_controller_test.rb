...
class AirportsControllerTest < ActionController::TestCase
  ...
  test "should create airport" do
    assert_difference('Airport.count') do
      post :create, airport: { city_id: @airport.city_id, key: @airport.key, km_to_city: @airport.km_to_city, name: @airport.name }
    end
  ...
  test "should update airport" do
    put :update, id: @airport, airport: { city_id: @airport.city_id, key: @airport.key, km_to_city: @airport.km_to_city, name: @airport.name }
    assert_redirected_to airport_path(assigns(:airport))
  end
